...
namespace WinFormsSpeciesFormationProblem10_6Jun2024
{
    public class Problem10 : Problem
    {
        public Problem10() : base(3)
        {
        ...
        public override double GetFitness(params double[] genes)
        {
            ...
            return 21.5 + x * Math.Sin(4 * Math.PI * x) + y * Math.Sin(20 * Math.PI * y) + y * Math.Sin(0.5 * Math.PI * y);
        }

        public override string ToString()
        {
            return "Maximization Problem of 21.5 + x * sin(4 Pi x) + y * sin(20 Pi y) + y * sin(0.5 Pi y)";
        }
    }
}
